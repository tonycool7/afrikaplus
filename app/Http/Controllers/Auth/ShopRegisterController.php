...
class ShopRegisterController extends Controller
{
    ...
    */
    ...
    protected $redirectIfVerified = '/shop/login';

    protected $redirectAfterVerification = '/shop/login';
    ...
    public function __construct()
    {
        ...
        $this->middleware('guest:shopUser', ['except' => ['resendVerification', 'getVerification', 'getVerificationError']]);
    }
    ...
    public function register(Request $request)
    {
        ...
        $this->guard('shopUser')->login($user);
